...
```{r dr1, echo=FALSE, fig.cap="Disclosure Rules for CTPP Tables Based on the Five-Year ACS"}
# No fig.retina (using default fig.retina = 2)
knitr::include_graphics("images/drb1.PNG") 
```
...
```{r t31, echo=FALSE, fig.cap="Changes between 2006 – 2010 CTPP and 2012 – 2016 CTPP"}
# No fig.retina (using default fig.retina = 2)
knitr::include_graphics("images/tab31.PNG") 
```
